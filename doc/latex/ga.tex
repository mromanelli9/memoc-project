...
La seconda parte della consegna prevedeva di eseguire il risolutore proposto,
analizzarne le prestazioni e compararle con quelle del risolutore CPLEX.
Anche in questo caso le prove sono state eseguite nel labotorio e utilizzando le istanze generate
...
\end{itemize}
In tabella~\ref{tab:risultati-ga} si possono trovare i tempi d'esecuzione dell'algoritmo, espressi in secondi;
i tempi medi sono anche rappresentati in figura\ref{fig:tempi-ga}.
La figura~\ref{fig:diff-tempi} mostra, invece, la differenza fra il tempo d'esecuzione (medio) fra il risolutore
CPELX e GA.
%
\begin{table}[!h]
\centering
...
\begin{figure}[!h]
\begin{center}
	\includegraphics[scale=.5]{tempi-ga}
...
\begin{figure}[!h]
\begin{center}
	\includegraphics[scale=.5]{diff-tempi}
...
%
\subsection{Possibilo-miglioramenti}\label{subsec:miglioramenti-ga}
